...
ROOT_URLCONF = "adams_backend.urls"
...
WSGI_APPLICATION = "adams_backend.wsgi.application"
ASGI_APPLICATION = "adams_backend.asgi.application"
...
if DB_ENGINE == "django.db.backends.postgresql":
    DATABASES = {
        "default": {
            "ENGINE": DB_ENGINE,
            "NAME": os.getenv("DB_NAME", "adams_boutique"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "adams_backend.pagination.AdamsPagination",
